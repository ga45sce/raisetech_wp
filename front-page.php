<?php get_header(); ?>
            ...
            <article>
                <div class="p-article-top">
                    <!--<img src="./img/phone_main.jpg" alt="メイン画像">-->
                ...
                <div class="p-article-map">
                    ...
                    <div class="p-article-map__layer1"></div>
                    <div class="p-article-map__layer2"></div>
                    <div class="p-article-map__area">
                        <h2 class="p-image-map__title">見出しが入ります</h2>
                        <p class="p-image-map__text">テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。</p>
                    </div>
                </div>
            </article>
        </div>
